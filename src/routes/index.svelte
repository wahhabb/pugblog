...
p. 
  ...
  applications that provides routing, server-side rendering, code-splitting, and more. 
  It is comparable to Next or Nuxt in React and Vue. It makes it quick and easy to 
